      ...
      <div className="w-full max-w-md academic-surface rounded-xl p-8 shadow-field-lg relative z-10 animate-rise-in">
        ...
        {message ? (
          <div className="py-6 text-center space-y-4">
            ...
            <p className="text-xs text-sage-300 leading-relaxed bg-[#1A2016] border border-[#37452E] rounded-xl p-4">
              {message}
            </p>
            <div className="pt-2">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 font-bold text-xs transition-colors"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <Mail className="w-4 h-4 text-sage-500 absolute top-1/2 -translate-y-1/2 left-3" />
                <input
                  type="email"
                  required
                  value={email}
